...
char cplot[MAXPLT][10],  /* array to hold commands             */
     ...
     order[10],          /* type of Multiplication order       */
     filed[10],         /* data file name string              */
     filee[45],         /* explain file name.  string         */
     fileh[10],         /* string for help file name          */
     filei[10],         /* string for ".inp" file name        */
     fileo[10],         /* string for ".out" file name        */
